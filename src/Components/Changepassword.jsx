...
<Sidebar activeprofile={"active"} />
      ...
      <form style={{ paddingRight: '50px'}}>
        ...
        <button className='btn-chnge-pass-sett' type="submit" style={{ backgroundColor: '#0b4945', color: 'white', padding: '10px 20px', border: 'none', borderRadius: '20px', cursor: 'pointer' }}>Change Password</button>
      </form>
                  </div>    
                </div>
            </main>

...
export default function Searchproducts() {
    const [visibleProducts, setVisibleProducts] = useState(16); // Initial number of visible products
  ...
  return (
    <>
                ...
                <div className="pro-container">
                    ...
                    {searchproducts.slice(0, visibleProducts).map(product => (
                ...
                {searchproducts.length > visibleProducts && (
                    <div >

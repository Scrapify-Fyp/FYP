...
//         console.log("🚀 ~ fetchUsershop ~ response.data:", response.data);
//       } catch (error) {
...
//           ) : (
//             <div>
//               <h2 style={{ color: '#980f0f', textAlign: 'center' }}>No shop found</h2>
...
//     try {
//       // Add logic to create a new shop
//       // Assuming the shop creation is successful
//       setShop(true);
//       setShowModal(false);
//     } catch (error) {
...
//         </Modal.Header>
//         <Modal.Body>
//           {/* Add your shop creation form here */}
//           <p>Shop creation form goes here...</p>
//         </Modal.Body>
//         <Modal.Footer>
...
//       const response = await axios.post('http://localhost:3002/shop', formData);
